                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  @foreach ($anggotas as $key => $value)
                    <tr>
                        ...
                        <a href="{{ route('anggota.show', $value->id) }}" class="btn btn-small btn-dark">Detail</a>
                        <a href="{{ route('anggota.edit', $value->id) }}" class="btn btn-small btn-secondary">Edit</a>
                      <a href="" type="sumbit" class="btn btn-small btn-dark" data-toggle="modal" data-target="#exampleModal">hapus</a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
